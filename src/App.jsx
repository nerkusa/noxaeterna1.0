...
u.push(onValue(ref(db,"rooms/"+room+"/dmgEvents"),function(s){sDmgEvents(s.val()||{})}));u.push(onValue(ref(db,"rooms/"+room+"/races"),function(s){sRacesData(s.val()||null)}));u.push(onValue(ref(db,"rooms/"+room+"/npcHits"),function(s){sNpcHits(s.val()||{})}));return function(){u.forEach(function(x){x()})}},[room]);
