      ...
      <div style={{background:"#fff",border:"1px solid "+(waiting?"#d1d5db":"#10b98140"),borderRadius:10,padding:"8px 12px",marginBottom:waiting?10:0}}>
        ...
        {waiting
          ...
          :<div>
            ...
            {!dodged&&<div style={{fontSize:10,color:"#8b7e6a",marginTop:6,fontStyle:"italic"}}>ГМ наносит урон...</div>}
          </div>
        }
      </div>
    </div>
...
else{oR({label:w.name+" Попад.",d10:d,parts:[{label:"REF",value:rv},{label:sk,value:sv2},{label:"Бнс",value:w.bonus||0}],total:t});}}} style={{flex:1,padding:4,borderRadius:5,border:"1px solid #3b82f620",background:"#eff6ff",cursor:"pointer",fontWeight:700,fontSize:9,color:"#1d4ed8",textAlign:"center"}}>{"🎯"+(tgtNpc?" →"+tgtNpc.name.slice(0,8):"")}</button>
