...
var _trs=useState(null);var traitsData=_trs[0];var sTraitsData=_trs[1];
...
function saveTraits(d){if(!room)return;set(ref(db,"rooms/"+room+"/traits"),d)}
