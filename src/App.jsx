...
<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
  <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:18,color:"#f59e0b"}}>💰 Донат-магазин</div>
  <div style={{display:"flex",gap:6}}>
    {isGM&&<button onClick={function(){sEditMode(!editMode);sEditPack(null)}} style={{padding:"3px 10px",borderRadius:5,border:"1px solid "+(editMode?"#f59e0b":"#4b3800"),background:editMode?"#f59e0b":"#1a1008",color:editMode?"#1a1008":"#f59e0b",cursor:"pointer",fontSize:9,fontWeight:700}}>{editMode?"✓ Готово":"✏️ Редактировать"}</button>}
    <button onClick={onClose} style={{background:"none",border:"1px solid #5c5548",borderRadius:5,padding:"3px 10px",color:"#e8e0d4",cursor:"pointer",fontSize:10}}>✕</button>
  </div>
</div>
