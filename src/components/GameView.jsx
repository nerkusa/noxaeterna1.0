...
var tabs=[{id:"character",l:"Игрок",ic:<IconChar/>},{id:"combat",l:"Бой",ic:<IconBattle/>},{id:"inventory",l:"Инв.",ic:<IconInv/>},{id:"party",l:"Группа",ic:<span style={{fontSize:15}}>👥</span>},{id:"library",l:"Лор",ic:<IconLib/>},{id:"guide",l:"Памятка",ic:<span style={{fontSize:15}}>📋</span>}];
