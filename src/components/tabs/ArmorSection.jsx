...
{!isEqSh&&<button disabled={shieldBlocked} onClick={function(){if(!shieldBlocked)sv(Object.assign({},c,{equippedShield:sh.id}));}} style={{fontSize:7,padding:"1px 5px",borderRadius:3,border:"1px solid #0369a120",background:"#0e2236",cursor:shieldBlocked?"not-allowed":"pointer",color:"#38bdf8",opacity:shieldBlocked?0.5:1}}>Надеть</button>}
...
<div style={{background:"#262219",borderRadius:2,height:4,overflow:"hidden"}}><div style={{height:"100%",width:shPct+"%",background:sh.hp<=0?"#ef4444":"#0369a1",borderRadius:2}}/></div>
