...
return <div key={sh.id} style={{background:isEqSh?"#0e2236":"#1d1a14",border:"1px solid "+(isEqSh?"#38bdf830":"#322d24"),borderRadius:5,padding:"3px 5px",marginBottom:3,display:"flex",flexDirection:"column",gap:2}}>
